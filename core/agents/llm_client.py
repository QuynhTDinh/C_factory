"""
Agent Factory LLM Client — Centralized LLM integration.
Supports Google Gemini (primary) and OpenAI GPT (fallback).
Adapted from FNX Talent Factory.
"""
...
class GeminiClient(LLMClient):
    ...
    def __init__(self, api_key: str = None, model: str = "gemini-2.0-flash"):
        ...
        if not self.api_key:
            raise ValueError(
                "GEMINI_API_KEY not found. Set as environment variable or pass directly."
            )
...
class OpenAIClient(LLMClient):
    ...
    def __init__(self, api_key: str = None, model: str = "gpt-4o-mini"):
        ...
        if not self.api_key:
            raise ValueError(
                "OPENAI_API_KEY not found. Set as environment variable or pass directly."
            )
